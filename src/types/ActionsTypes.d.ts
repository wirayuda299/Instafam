...
export type ActionsType = TogglePostPreviewModalAction | ToggleMenuModalAction | SetResultAction | ToggleSearchDrawerAction | ToggleExtraListAction | SelectPostAction | ResultDrawerAction | FeedModalAction | PostModalAction | postCommentModalAction | NotificationDrawerAction | NotificationModalAction | PostCrateModalAction | PostReportModalAction | SetBlurHashAction | SetPreviewUrlAction | CroppedImageAction | ReceiverDrawerAction | MessageModalAction | chatRoomSelectedAction  