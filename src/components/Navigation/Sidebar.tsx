...
export default function Sidebar() {
	...
	return (
		<aside
		className={`w-full md:w-fit fixed bottom-0 left-0 z-50 h-12 md:h-screen md:border-r md:staticmd:dark:border-r-gray-600 flex md:static items-center transition-all ease duration-300 ${
