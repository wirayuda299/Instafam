...
const PostCommentDesktop = dynamic(() => import("../Post/PreviewDesktop"), { ssr: false });
const PreviewMobile = dynamic(() => import("../Post/PreviewMobile"), { ssr: false });
      ...
      <div className="h-full w-full ">
        <div className="h-full w-full overflow-y-auto">
          <div className="mx-auto grid h-screen w-full max-w-5xl place-items-center rounded-lg ">
            <div className={`relative grid h-full w-full grid-cols-1 justify-between overflow-y-auto rounded-xl p-5 shadow-2xl  lg:max-h-[530px] lg:grid-cols-2 lg:p-0 ${darkMode ? 'bg-black' : 'bg-white'} `}>
              <PreviewMobile
                post={post}
                likes={likes}
                comments={comments}
