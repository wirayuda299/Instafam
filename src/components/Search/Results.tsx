          ...
          {results?.length === 0 ? (
            ...
            <>
              {results && results?.map((result) => (
                <div
                  className={`mb-3 flex w-full items-center py-2 justify-between border-b border-gray-500 border-opacity-50 pb-5 ${darkMode ? "bg-black text-white" : "bg-white text-black"
                    }`}
                  key={result.uid}
                >
                  <Link
